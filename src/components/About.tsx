        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div ref={imageRef} className="relative">
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="aspect-square bg-gradient-to-br from-primary-500/20 to-accent-500/20 rounded-2xl border border-primary-500/30 flex items-center justify-center backdrop-blur-sm">
                <div className="w-32 h-32 bg-gradient-to-br from-primary-400 to-accent-400 rounded-full flex items-center justify-center">
                  <span className="text-4xl font-bold text-white">GR</span> {/* Changed to your initials */}
                </div>
              </div>
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div className="bg-dark-50/50 p-4 rounded-lg border border-dark-200/30">
                ...
                <p className="text-2xl font-bold text-white">3+ Years</p> {/* Updated based on your CV */}
              </div>
              <div className="bg-dark-50/50 p-4 rounded-lg border border-dark-200/30">
                <h4 className="text-accent-400 font-semibold mb-2">Projects</h4>
                <p className="text-2xl font-bold text-white">8+ Completed</p> {/* Updated based on your CV */}
              </div>
            </div>
          </div>
        </div>
